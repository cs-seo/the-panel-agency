        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 grid lg:grid-cols-[1fr_auto] gap-10 items-center">
          <div className="max-w-xl">
            ...
            <p className="mt-4 text-ink-muted leading-relaxed">
              A short Friday email: one Knowledge Panel teardown, one entity-SEO
              tactic, one piece of news from the AI-overview era. No fluff, no
              sponsor reads, no recap of what every other SEO newsletter sent
              you that week.
            </p>
            <ul className="mt-5 flex flex-wrap gap-x-5 gap-y-2 text-[12px] text-ink-dim">
              <li className="flex items-center gap-1.5">
                <Mail size={12} className="text-gold" /> Weekly, Friday morning UK
              </li>
              <li className="flex items-center gap-1.5">
                <ShieldCheck size={12} className="text-gold" /> Never shared
              </li>
              <li className="flex items-center gap-1.5">
                <ShieldCheck size={12} className="text-gold" /> One-click unsubscribe
              </li>
            </ul>
          </div>
          <div className="w-full lg:w-[420px]">
            <LeadCaptureForm
              name="newsletter"
              eyebrow="Join 0+ readers"
              title="Subscribe"
              blurb="One email a week. Unsubscribe in one click."
              buttonLabel="Subscribe to the briefing"
              successMessage="You're on the list. The next briefing ships Friday."
            />
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 grid gap-10 md:grid-cols-6">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-md text-sm text-ink-muted leading-relaxed">
              White-glove Google Knowledge Panel establishment and entity management for
              founders, executives, authors, artists, and public figures.
            </p>
